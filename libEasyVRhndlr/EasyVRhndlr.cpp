/*
 *  EasyVR Handler.cpp
 *  Handler for the EasyVR voice recognition module.
 *  
 *  Recreated from SPIN code version January 2014 By Paul Bammel
 *  Original SPIN code writen by Paul Bammel Dec 2013
 */
